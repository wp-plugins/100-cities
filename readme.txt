...
= I have changed the feed url but the information and links on related posts still the same =

The cache last for 2 days, after two days it will read the feed again for that city, if you want to delete the cache it is in the folder called "cache" in the plugin's directory ("/wp-content/plugins/100cities/cache/")
